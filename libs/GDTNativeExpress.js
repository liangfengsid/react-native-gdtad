...
const RNGDTNativeExpress = requireNativeComponent("GDTNativeExpress", GDTNativeExpress);

export default class GDTNativeExpress extends PureComponent {
    ...
    render() {
        return <RNGDTNativeExpress {...this.props} onFailToReceived={this._onFailToReceived.bind(this)}/>;
    }
}